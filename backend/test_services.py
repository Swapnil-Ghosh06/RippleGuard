...
from api.services.npm_service import (
    get_latest_version, get_monthly_downloads, get_downloads_batch
)
from api.services.pypi_service import (
    get_pypi_metadata, parse_pypi_deps
)
from api.services.deps_service import (
    get_all_deps_as_flat_list
)
from api.services.osv_service import (
...
from api.services.famous_attacks import (
